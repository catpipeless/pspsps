#slight modification of https://github.com/nullbind/Powershellery/blob/master/Brainstorming/Exfil/generate-cc-validated.ps1
# Author: ktaranov
...
function Generate-CreditCards
{
    ...
    Param(
        ...
        $Number = 1
            ...
            $script:obj_list = $script:valid_list | Select-Object @{Name="Credit Card Number";Expression={$_}}
            $script:obj_list | export-csv -Path "Credit_Cards.csv" -NoTypeInformation
