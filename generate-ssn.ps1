# Slight Modification of https://github.com/nullbind/Powershellery/blob/master/Brainstorming/Exfil/generate-ssn.ps1
...
function Generate-SSN
{
    ...
    Param(
        ...
        $obj_SSN = $Script:AllSSN | Select-Object @{Name="Social Security Number";Expression={$_}}
        $obj_SSN | Export-Csv -Path "SSNs.csv" -NoTypeInformation
}
